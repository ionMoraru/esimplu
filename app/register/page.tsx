        ...
        <div className="rounded-2xl bg-card px-8 py-10 flex flex-col gap-6">
          ...
          <form action={action} className="flex flex-col gap-3">
            <div className="flex flex-col gap-1.5">
              ...
              <Input id="name" name="name" type="text" placeholder="Ion Popescu" required autoComplete="name" />
            </div>

            <div className="flex flex-col gap-1.5">
              <label htmlFor="email" className="text-sm font-medium">Email</label>
              <Input id="email" name="email" type="email" placeholder="nume@exemplu.com" required autoComplete="email" />
            </div>

            <div className="flex flex-col gap-1.5">
              <label htmlFor="password" className="text-sm font-medium">Parolă</label>
              <Input id="password" name="password" type="password" placeholder="Minim 8 caractere" required minLength={8} autoComplete="new-password" />
            </div>

            <div className="flex flex-col gap-1.5">
              <label htmlFor="confirm" className="text-sm font-medium">Confirmați parola</label>
          ...
          <p className="text-center text-xs text-muted-foreground">
            ...
            <a href="/terms" className="underline underline-offset-2 hover:text-foreground">termenii</a>
            {" "}și{" "}
            <a href="/privacy" className="underline underline-offset-2 hover:text-foreground">confidențialitatea</a>.
          </p>

          {/* Login link */}
          <p className="text-center text-sm text-muted-foreground">
            Aveți deja un cont?{" "}
            <a href="/login" className="font-medium text-foreground underline underline-offset-2 hover:text-foreground/80">
              Conectați-vă
            </a>
          </p>
