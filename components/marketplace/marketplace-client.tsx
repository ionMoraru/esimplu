...
import type { DisplayProductWithMeta, DisplayProducer } from "@/lib/marketplace/display"
...
interface Props {
  products: DisplayProductWithMeta[]
  producers: DisplayProducer[]
  categories: CategoryOption[]
}

export function MarketplaceClient({ products, producers, categories }: Props) {
    ...
    () =>
      products.filter((product) => {
        const categoryMatch =
          ...
          (product.category != null && product.category === selectedCategory)
        const countryMatch =
          selectedCountry === "all" ||
          product.countriesAvailable.includes(selectedCountry)
